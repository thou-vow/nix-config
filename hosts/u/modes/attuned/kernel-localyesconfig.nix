lib: with lib.kernel; {
  ...
  "DEBUG_LIST" = no;
  "DEBUG_MISC" = no;
  "DEBUG_RODATA_TEST" = yes;
  "DEBUG_SHIRQ" = yes;
  "DEFAULT_SECURITY_APPARMOR" = no;
  ...
  "HOTPLUG_PCI_CPCI" = yes;
  "HOTPLUG_PCI_SHPC" = yes;
  "HPFS_FS" = no;
  "HP_ACCEL" = no;
  "HP_BIOSCFG" = no;
  "HP_ILO" = no;
  ...
  "MMC_WBSD" = no;
  "MMIOTRACE" = yes;
  "MODULE_ALLOW_BTF_MISMATCH" = no;
  "MODULE_ALLOW_MISSING_NAMESPACE_IMPORTS" = yes;
  ...
  "MODULE_UNLOAD_TAINT_TRACKING" = yes;
  "MOST" = no;
  "MOTORCOMM_PHY" = no;
  "MOUSE_APPLETOUCH" = no;
  "MOUSE_BCM5974" = no;
  ...
  "MOUSE_GPIO" = no;
  "MOUSE_PS2" = yes;
  "MOUSE_PS2_SENTELIC" = yes;
  "MOUSE_PS2_TOUCHKIT" = yes;
  "MOUSE_SERIAL" = no;
  ...
  "RANDOM_KMALLOC_CACHES" = no;
  "RAPIDIO" = no;
  "RAVE_SP_CORE" = no;
  "RCU_EXPERT" = yes;
  "RCU_LAZY_DEFAULT_OFF" = yes;
  ...
  "SOFT_WATCHDOG" = no;
  "SOLARIS_X86_PARTITION" = yes;
  "SONY_LAPTOP" = no;
  "SOUND" = yes;
  "SOUNDWIRE" = no;
  "SOUND_OSS_CORE_PRECLAIM" = no;
  "SP5100_TCO" = no;
  "SPEAKUP" = no;
  "SPI_ALTERA" = no;
  "SPI_AMD" = no;
  ...
  "ACRN_HSM" = no;
  "AS_IS_LLVM" = yes;
  "ATH9K_COMMON_DEBUG" = yes;
  "ATH9K_COMMON_SPECTRAL" = yes;
  "ATH9K_STATION_STATISTICS" = yes;
  "ATOMIC64_SELFTEST" = no;
  "AUTOFDO_CLANG" = no;
  "AX25" = no;
  ...
  "BATTERY_DA9030" = no;
  "BATTERY_DA9052" = no;
  "BOOT_CONFIG_EMBED" = no;
  "BOOT_CONFIG_FORCE" = no;
  ...
  "DEFAULT_FQ" = yes;
  "DEFAULT_FQ_CODEL" = no;
  "DEFAULT_PFIFO_FAST" = no;
  "DEFAULT_SECURITY_SMACK" = no;
  "DMABUF_HEAPS_CMA" = yes;
  "DMABUF_HEAPS_SYSTEM" = yes;
  "DRM_CLIENT_DEFAULT_LOG" = no;
  "DVB_AV7110" = no;
  "DVB_VIDTV" = no;
  "EXT4_USE_FOR_EXT2" = yes;
  "EXTCON_MAX77843" = no;
  "EXTCON_MAX8997" = no;
  "FIND_BIT_BENCHMARK" = no;
  "FORCE_NEED_SRCU_NMI_SAFE" = no;
  "FORCE_TASKS_RCU" = no;
  "FORCE_TASKS_RUDE_RCU" = no;
  "FORCE_TASKS_TRACE_RCU" = no;
  "FPROBE_EVENTS" = yes;
  "FS_DAX_PMD" = yes;
  "FS_VERITY_BUILTIN_SIGNATURES" = yes;
  "FTRACE_MCOUNT_USE_OBJTOOL" = yes;
  "FUSE_DAX" = yes;
  "GENERIC_IRQ_STAT_SNAPSHOT" = yes;
  ...
  "INTEL_ATOMISP" = no;
  "INTERVAL_TREE_TEST" = no;
  "IPE_POLICY_SIG_PLATFORM_KEYRING" = yes;
  "IPE_POLICY_SIG_SECONDARY_KEYRING" = yes;
  "IPE_PROP_FS_VERITY" = yes;
  "IPE_PROP_FS_VERITY_BUILTIN_SIG" = yes;
  "ISDN_CAPI" = yes;
  ...
  "LKDTM" = no;
  "LOAD_UEFI_KEYS" = yes;
  "LOCK_DOWN_KERNEL_FORCE_CONFIDENTIALITY" = no;
  "LOCK_DOWN_KERNEL_FORCE_INTEGRITY" = no;
  ...
  "MODULE_SIG_KEY_TYPE_RSA" = no;
  "MODULE_SIG_SHA1" = no;
  "MODULE_SIG_SHA256" = no;
  "MODULE_SIG_SHA384" = no;
  "MODULE_SIG_SHA3_256" = no;
  "MODULE_SIG_SHA3_384" = no;
  "MODULE_SIG_SHA3_512" = no;
  "MODULE_SIG_SHA512" = yes;
  "NCSI_OEM_CMD_GET_MAC" = yes;
  "NCSI_OEM_CMD_KEEP_PHY" = yes;
  "NVSW_SN2201" = no;
  ...
  "RBTREE_TEST" = no;
  "RCU_BOOST" = yes;
  "RCU_CPU_STALL_NOTIFIER" = no;
  "RCU_DOUBLE_CHECK_CB_TIME" = yes;
  "RCU_EXP_KTHREAD" = no;
  "RCU_NOCB_CPU_CB_BOOST" = no;
  "REED_SOLOMON_TEST" = no;
  ...
  "SCSI_DH_HP_SW" = no;
  "SCSI_DH_RDAC" = no;
  "SECONDARY_TRUSTED_KEYRING_SIGNED_BY_BUILTIN" = no;
  "SECURITY_LOADPIN_ENFORCE" = yes;
  "SECURITY_LOCKDOWN_LSM_EARLY" = no;
  ...
  "SIGNATURE" = yes;
  "SND_CTL_DEBUG" = no;
  "SND_DEBUG_VERBOSE" = no;
  "SND_JACK_INJECTION_DEBUG" = no;
  "SND_PCM_XRUN_DEBUG" = no;
  "SND_SE6X" = no;
  ...
  "SPI_SLAVE_TIME" = no;
  "STAGING_MEDIA_DEPRECATED" = no;
  "SYNTH_EVENT_GEN_TEST" = no;
  "SYSTEM_BLACKLIST_AUTH_UPDATE" = yes;
  "SYSTEM_REVOCATION_LIST" = yes;
  "TASKS_TRACE_RCU_READ_MB" = no;
  "TEST_BITMAP" = no;
  "TEST_BITOPS" = no;
  "TEST_BPF" = no;
  "TEST_CLOCKSOURCE_WATCHDOG" = no;
  "TEST_DHRY" = no;
  "TEST_DIV64" = no;
  "TEST_DYNAMIC_DEBUG" = no;
  "TEST_FIRMWARE" = no;
  "TEST_FPU" = no;
  "TEST_FREE_PAGES" = no;
  "TEST_HEXDUMP" = no;
  ...
  "TEST_VMALLOC" = no;
  "TEST_XARRAY" = no;
  "THERMAL_DEFAULT_GOV_POWER_ALLOCATOR" = no;
  ...
  "XEN_GRANT_DMA_OPS" = yes;
  "XEN_VIRTIO_FORCE_GRANT" = no;
}
